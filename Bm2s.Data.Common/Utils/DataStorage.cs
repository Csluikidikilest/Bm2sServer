...
namespace Bm2s.Data.Common.Utils
{
  public class DataStorage : Bm2s.Data.Utils.DataStorage
  {
    ...
    public void CreateDatasForTest()
    {
      ...
      HeaderLine headerLine1 = new HeaderLine() { ArticleId = article1.Id, ArticleFamilyId = article1.ArticleFamilyId, ArticleSubFamilyId = article1.ArticleSubFamilyId, BrandId = article1.BrandId, Code = article1.Code, Description = article1.Description, Designation = article1.Designation, HeaderId = header.Id, BuyPrice = 0, HeaderLineTypeId = headerLineType.Id, IsPrintable = true, LineNumber = 1, Quantity = 2, SellPrice = 20.10, UnitId = article1.UnitId, VatRate = 19.6 };
      this.HeaderLines.Add(headerLine1);
      HeaderLine headerLine2 = new HeaderLine() { ArticleId = article2.Id, ArticleFamilyId = article2.ArticleFamilyId, ArticleSubFamilyId = article2.ArticleSubFamilyId, BrandId = article2.BrandId, Code = article2.Code, Description = article2.Description, Designation = article2.Designation, HeaderId = header.Id, BuyPrice = 0, HeaderLineTypeId = headerLineType.Id, IsPrintable = true, LineNumber = 1, Quantity = 3, SellPrice = 20.20, UnitId = article2.UnitId, VatRate = 19.6 };
      this.HeaderLines.Add(headerLine2);
      HeaderLine headerLine3 = new HeaderLine() { ArticleId = article3.Id, ArticleFamilyId = article3.ArticleFamilyId, ArticleSubFamilyId = article3.ArticleSubFamilyId, BrandId = article3.BrandId, Code = article3.Code, Description = article3.Description, Designation = article3.Designation, HeaderId = header.Id, BuyPrice = 0, HeaderLineTypeId = headerLineType.Id, IsPrintable = true, LineNumber = 1, Quantity = 4, SellPrice = 20.30, UnitId = article3.UnitId, VatRate = 19.6 };
