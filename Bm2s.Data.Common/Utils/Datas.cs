...
namespace Bm2s.Data.Common.Utils
{
  ...
  public class Datas
  {
    ...
    public void CreateDatasForTest()
    {
      ...
      Datas.Instance.DataStorage.Articles.Add(arti11);
